    ...
    <td class="text-end ml-10">
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
            ...
            <div class="menu-item px-3">
                <a href="{{route('tag.show',$category)}}" class="menu-link px-3">
                    View
                </a>
            </div>
            <!--end::Menu item-->
            <div class="menu-item px-3">
                <a href="{{route('tag.edit',$category)}}" class="menu-link px-3">
                    Edit
                </a>
            </div>
            ...
            <!--begin::Menu item-->
            <div class="menu-item px-3">
                <form action="{{route('tag.destroy',$category)}}" method="POST">
                    @csrf
                    @method('DELETE')
