                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                <i class="ki-duotone ki-magnifier fs-3 position-absolute ms-4"><span
                                    ...
                                    class="form-control form-control-solid w-250px ps-12" placeholder="Search Media" />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--end::Card title-->
                ...
                <tbody class="fw-semibold text-gray-600">
                    <tr>
                        ...
                        <td class="text-end pe-0">
                            <span class="fw-bold">{{$_media->name}}</span>
                        </td>
                        <td class="text-end pe-0">
                            <span class="fw-bold">{{$_media->type}}</span>
                        </td>
                        <td class="text-end pe-0">
                            <!--begin::Badges-->
                            <span class="fw-bold">{{$_media->path}}</span>
                            <!--end::Badges-->
                        </td>
                        <td class="text-end pe-0">
                            <!--begin::Badges-->
                            <span class="fw-bold">{{$_media->size}}</span>
                            <!--end::Badges-->
                        </td>
                        <td class="text-end pe-0">
                            <!--begin::Badges-->
                            <span class="fw-bold">{{$_media->article_id}}</span>
                            <!--end::Badges-->
                        </td>
