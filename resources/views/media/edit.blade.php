                ...
                <div id="kt_app_toolbar" class="app-toolbar align-items-center justify-content-between py-4 py-lg-6">
                    ...
                    <div class="d-flex flex-grow-1 flex-stack flex-wrap gap-2" id="kt_toolbar">
                        ...
                        <div class="d-flex flex-column align-items-start me-3 gap-1 gap-lg-2">
                            <!--begin::Title-->
                            <h1 class="d-flex text-gray-900 fw-bold m-0 fs-3">Edit Media</h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                            <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                                ...
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="breadcrumb-item text-gray-500">Edit Media</li>
                                <!--end::Item-->
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                ...
                <div>
                    ...
                    <div id="kt_app_content" class="app-content flex-column-fluid">
                        <form id="kt_ecommerce_add_category_form" method="POST"
                            action="{{route('media.update',$media)}}" class="form d-flex flex-column flex-lg-row">
                            @csrf
                            @method('PUT')
                            <!--begin::Aside column-->
                                    ...
                                    <div class="card-body text-center pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" name="name"
                                                ...
                                                placeholder="Name" value="{{old('name',$media->name)}}" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="file" name="path"
                                                ...
                                                placeholder="Path File" value="{{old('path',$media->path)}}" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="number" name="size"
                                                ...
                                                placeholder="Size" value="{{old('size',$media->size)}}" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
