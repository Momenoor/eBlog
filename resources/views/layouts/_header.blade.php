    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        ...
                                                        <a href="index.html" class="menu-link">
                                                            ...
                                                            <span class="d-flex flex-column">
																					...
																					<span
                                                                                        class="fs-7 fw-semibold text-muted">Reports & statistics</span>
																				</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    </div>
                                                        ...
                                                        <a href="dashboards/projects.html"
                                                           class="menu-link">
                                                            ...
                                                            <span class="d-flex flex-column">
																					...
																					<span
                                                                                        class="fs-7 fw-semibold text-muted">Tasts, graphs & charts</span>
																				</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    </div>
                                                        ...
                                                        <a href="dashboards/marketing.html"
                                                           class="menu-link">
                                                            ...
                                                            <span class="d-flex flex-column">
																					...
																					<span
                                                                                        class="fs-7 fw-semibold text-muted">Campaings & conversions</span>
																				</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    </div>
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex flex-column me-5">
                                                    ...
                                                    <div class="fs-7 fw-semibold text-muted">Onpe page
                                                        landing template with pricing & others
                                                    </div>
                                                </div>
                                                <a href="landing.html"
                                                            ...
                                                            <div class="mb-6">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    ...
                                                                    <a href="pages/team.html"
                                                                       class="menu-link">
                                                                                    <span
                                                                                        class="menu-title">Our Team</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                                <!--end:Menu item-->
                                                            ...
                                                            <div class="mb-6">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    ...
                                                                    <a href="pages/faq/classic.html"
                                                                       class="menu-link">
                                                                                    <span
                                                                                        class="menu-title">FAQ Classic</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                                <!--end:Menu item-->
                                                            ...
                                                            <div class="mb-6">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    ...
                                                                    <a href="pages/blog/home.html"
                                                                       class="menu-link active">
                                                                                    <span
                                                                                        class="menu-title">Blog Home</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                                <!--end:Menu item-->
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    ...
                                                                    <a href="pages/blog/post.html"
                                                                       class="menu-link">
                                                                                    <span
                                                                                        class="menu-title">Blog Post</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                                <!--end:Menu item-->
                                                            ...
                                                            <div class="mb-0">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    ...
                                                                    <a href="utilities/modals/forms/new-target.html"
                                                                       class="menu-link">
                                                                                    <span
                                                                                        class="menu-title">New Target</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                                <!--end:Menu item-->
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    ...
                                                                    <a href="utilities/modals/forms/new-card.html"
                                                                       class="menu-link">
                                                                                    <span
                                                                                        class="menu-title">New Card</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                                <!--end:Menu item-->
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    ...
                                                                    <a href="utilities/modals/forms/new-address.html"
                                                                       class="menu-link">
                                                                                    <span
                                                                                        class="menu-title">New Address</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                                <!--end:Menu item-->
                                                            ...
                                                            <div class="mb-6">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    ...
                                                                    <a href="utilities/modals/wizards/create-app.html"
                                                                       class="menu-link">
                                                                                    <span
                                                                                        class="menu-title">Create App</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                                <!--end:Menu item-->
            ...
            <div class="topbar d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-stretch">
                    <!--begin::Menu wrapper-->
                    <div class="topbar-item px-3 px-lg-4" data-kt-menu-trigger="click"
                         data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end"
                         data-kt-menu-flip="bottom">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px"
                        ...
                        <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10"
                            ...
                            <!--begin::Status-->
                            <span
                                class="badge bg-primary text-inverse-primary py-2 px-3">25 pending tasks</span>
                            <!--end::Status-->
                        </div>
                        <!--end::Heading-->
                        <!--begin:Nav-->
