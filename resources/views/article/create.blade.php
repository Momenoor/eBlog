            ...
            <div class="card-body pt-0">
                ...
                <label for="kt_ecommerce_add_category_status_select">
                    <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                        data-placeholder="Select an category" id="kt_ecommerce_add_category_status_select"
                        name="category_id">
                        <option></option>
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-10">
                        ...
                        <select id="tags" data-control="select2"
                            class="form-control mb-2  @error('tags') is-invalid @enderror" name="tags[]"
                            data-placeholder="Tag name" data-close-on-select="false" multiple="multiple">
                            <option></option>
                            @foreach($tags as $tag)
