                            ...
                            <div class="mb-8">
                                ...
                                <div class="d-flex flex-wrap mb-6">
                                    ...
                                    <div class="me-9 my-1">
                                        ...
                                        <!--begin::Label-->
                                        <span
                                            class="fw-bold text-gray-500">{{$article->created_at->diffForHumans()}}</span>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Item-->
                                    ...
                                    <div class="my-1">
                                        ...
                                        <!--begin::Label-->
                                        <span
                                            class="fw-bold text-gray-500">{{$article->comments_count}} Comments</span>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Item-->
                                </div>
                            ...
                            @foreach($recentArticles as $article)
                                ...
                                <div class="d-flex mb-7">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <span
                                            class="text-gray-600 fw-semibold d-block pt-1 fs-7">{!! $article->excerpt() !!}</span>
                                    </div>
                                    <!--end::Title-->
                                </div>
                            @endforeach
