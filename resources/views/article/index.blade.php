                                        ...
                                        <div
                                            ...
                                            <div class="mb-3">
                                                <img class="embed-responsive-item card-rounded h-275px w-100"
                                                    src="{{asset($firstArticle->heroImage->path??null)}}" />
                                            </div>
                                            <!--end::Video-->
                                            <!--begin::Body-->
                                            <div class="mb-5">
                                            ...
                                            <div class="d-flex flex-stack flex-wrap">
                                                ...
                                                <div class="d-flex align-items-center pe-2">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle me-3">
                                                        @if ($firstArticle->author->profile_picture == null)
                                                        <img alt="" src="{{asset('assets/media/avatars/blank.png')}}" />
                                                        @else
                                                        <img alt=""
                                            ...
                                            <div class="d-flex flex-stack flex-wrap">
                                                ...
                                                <div class="d-flex align-items-center pe-2">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle me-3">
                                                        ...
                                                        <img src="{{asset('assets/media/avatars/blank.png')}}" class=""
                                                            alt="" />
                                                        @else
