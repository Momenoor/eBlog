            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5 " id="kt_ecommerce_products_table">
                ...
                <tbody class="fw-semibold text-gray-600">
                    <tr>
                        ...
                        <td class="text-end pe-0">
                            <span class="fw-bold">{{$article->body}}</span>
                        </td>
                        <td class="text-end pe-0">
                            <span class="fw-bold">{{$article->category_id}}</span>
                        </td>
                        <td class="text-end pe-0">
                            <span class="fw-bold">{{$article->tag}}</span>
                        </td>
                        <td class="text-end ml-10">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{route('article.show',$article)}}" class="menu-link px-3">
                                        View
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{route('article.edit',$article)}}" class="menu-link px-3">
                                        Edit
                                    </a>
                                </div>
                                <!--begin::Menu item-->
